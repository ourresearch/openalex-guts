...
util.f_matching_author_string(origName character varying(65535))
...
AS $$
    ...
    ### start of the contents of f_normalize_author_string
    ...
    try:
        ...
        result = ' '.join(words)
        normalized_string = result.lower()
    ### end of the contents of f_normalize_author_string
