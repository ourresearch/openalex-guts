...
run_queue_store_work: python -m scripts.queue --run --table=work --method=store --chunk=250 --name=queue_work$DYNO-${i} --randstart
...
run_queue_work_add_everything: python -m scripts.queue --run --table=work --method=add_everything --chunk=250 --name=$DYNO --randstart
