...
def get_objects(entity_type, object_ids):
    ...
    if entity_type == "work":
        objects = db.session.query(models.Work).options(
            ...
            selectinload(models.Work.records).selectinload(models.Record.journals).lazyload(models.Source.merged_into_source).lazyload(models.Source.merged_into_source).selectinload(models.Source.publisher_entity).selectinload(models.Publisher.self_and_ancestors).raiseload('*'),
            selectinload(models.Work.records).selectinload(models.Record.journals).lazyload(models.Source.merged_into_source).lazyload(models.Source.merged_into_source).selectinload(models.Source.publisher_entity).raiseload('*'),
            selectinload(models.Work.records).selectinload(models.Record.journals).lazyload(models.Source.merged_into_source).lazyload(models.Source.merged_into_source).selectinload(models.Source.institution).raiseload('*'),
            selectinload(models.Work.records).selectinload(models.Record.journals).lazyload(models.Source.merged_into_source).lazyload(models.Source.merged_into_source).raiseload('*'),
            selectinload(models.Work.records).selectinload(models.Record.journals).lazyload(models.Source.merged_into_source).selectinload(models.Source.publisher_entity).selectinload(models.Publisher.self_and_ancestors).raiseload('*'),
            selectinload(models.Work.records).selectinload(models.Record.journals).lazyload(models.Source.merged_into_source).selectinload(models.Source.publisher_entity).raiseload('*'),
            selectinload(models.Work.records).selectinload(models.Record.journals).lazyload(models.Source.merged_into_source).selectinload(models.Source.institution).raiseload('*'),
            selectinload(models.Work.records).selectinload(models.Record.journals).lazyload(models.Source.merged_into_source).raiseload('*'),
            ...
            selectinload(models.Work.locations).selectinload(models.Location.journal).lazyload(models.Source.merged_into_source).selectinload(models.Source.publisher_entity).selectinload(models.Publisher.self_and_ancestors).raiseload('*'),
            selectinload(models.Work.locations).selectinload(models.Location.journal).lazyload(models.Source.merged_into_source).selectinload(models.Source.publisher_entity).raiseload('*'),
            selectinload(models.Work.locations).selectinload(models.Location.journal).lazyload(models.Source.merged_into_source).selectinload(models.Source.institution).raiseload('*'),
            selectinload(models.Work.locations).selectinload(models.Location.journal).lazyload(models.Source.merged_into_source).raiseload('*'),
            ...
            selectinload(models.Work.journal).lazyload(models.Source.merged_into_source).selectinload(models.Source.publisher_entity).selectinload(models.Publisher.self_and_ancestors).raiseload('*'),
            selectinload(models.Work.journal).lazyload(models.Source.merged_into_source).selectinload(models.Source.publisher_entity).raiseload('*'),
            selectinload(models.Work.journal).lazyload(models.Source.merged_into_source).selectinload(models.Source.institution).raiseload('*'),
            selectinload(models.Work.journal).lazyload(models.Source.merged_into_source).raiseload('*'),
            ...
            selectinload(models.Work.safety_journals).lazyload(models.Source.merged_into_source).selectinload(models.Source.publisher_entity).selectinload(models.Publisher.self_and_ancestors).raiseload('*'),
            selectinload(models.Work.safety_journals).lazyload(models.Source.merged_into_source).selectinload(models.Source.institution).raiseload('*'),
            selectinload(models.Work.safety_journals).lazyload(models.Source.merged_into_source).selectinload(models.Source.publisher_entity).raiseload('*'),
            selectinload(models.Work.safety_journals).lazyload(models.Source.merged_into_source).raiseload('*'),
