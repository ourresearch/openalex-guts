...
class ConceptAncestor(db.Model):
    ...
    id = db.Column(db.BigInteger, db.ForeignKey("mid.concept_api_mv.field_of_study_id"), primary_key=True)
    ancestor_id = db.Column(db.BigInteger, db.ForeignKey("mid.concept_api_mv.field_of_study_id"), primary_key=True)
